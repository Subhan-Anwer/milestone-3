...
document.getElementById("form")?.addEventListener("submit", function(e) {
    ...
    const professionValue = (document.getElementById("professionInput")as HTMLInputElement).value;
    ...
    const userSkill1Level = (document.getElementById("skill-level-1")as HTMLInputElement).value;
    const userSkill2      = (document.getElementById("skill-2")as HTMLInputElement).value;
    const userSkill2Level = (document.getElementById("skill-level-2")as HTMLInputElement).value;
    const userSkill3      = (document.getElementById("skill-3")as HTMLInputElement).value;
    const userSkill3Level = (document.getElementById("skill-level-3")as HTMLInputElement).value;
    const userSkill4      = (document.getElementById("skill-4")as HTMLInputElement).value;
    const userSkill4Level = (document.getElementById("skill-level-4")as HTMLInputElement).value;
    const userSkill5      = (document.getElementById("skill-5")as HTMLInputElement).value;
    const userSkill5Level = (document.getElementById("skill-level-5")as HTMLInputElement).value;
    const userSkill6      = (document.getElementById("skill-6")as HTMLInputElement).value;
    const userSkill6Level = (document.getElementById("skill-level-6")as HTMLInputElement).value;
